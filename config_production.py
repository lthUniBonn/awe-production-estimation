...
# power curves:
run_marker = '' # default = ''
power_curve_output_file_name = result_dir + 'power_curve_{{i_profile}}_{data_info}{run_info}.{{suffix}}'.format(
...
step=1
location_number = jobnum*step # -1 #select loctions up to location number, -1: all locs #up to +400
